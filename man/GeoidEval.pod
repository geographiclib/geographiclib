...
the environment variable C<GEOGRAPHICLIB_GEOID_NAME> or with the B<-n> option.  The
...
C<GEOGRAPHICLIB_GEOID_PATH> or C<GEOGRAPHICLIB_DATA>, or with the B<-d> option.  The
...
option reports the value of B<GEOGRAPHICLIB_GEOID_NAME>, if defined, otherwise it
