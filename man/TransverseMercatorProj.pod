...
I<f> E<lt> 0 for a prolate ellipsoid (only supported with the series
method).  If I<f> E<gt> 1, the flattening is set to 1/I<f>.  By default,
the WGS84 ellipsoid is used, I<a> = 6378137m, I<f> = 1/298.257223563.
