...
ellipsoid:
  ...
  echo 40:38:23N 073:46:44W-14.93W X 01:21:33N 103:59:22E-14.93W |
    tr X '\n' | sed 's/$/ 0/' | CartConvert | Cart3Convert -E -r |
    tr '\n' ' ' | Geod3Solve -i -: -p 0
  => 003:12:53.3 177:29:00.3 15347609

The steps here are shift for longitude of major axis (-14.93d), convert
to geocentric for the biaxial Earth, convert to ellipsoidal for triaxial
Earth, compute geodesic distance.  Note that the resulting directions
are relative to the triaxial coordinates; additional calls to
Cart3Convert could be made to convert these to directions on the biaxial
Earth.
