...
use magnetic field model I<name> instead of the default C<wmm2015v2>.  See
L</MODELS>.
...
By default, the C<wmm2015v2> magnetic model is used.  This may changed by
...
Override the compile-time default magnetic name of C<wmm2015v2>.  The
...
The magnetic field from WMM2015v2 in Timbuktu on 2016-01-01

    echo 2016-01-01 16:46:33N 3:00:34W 300 | MagneticField -r
    => -2.10 12.14 33877.0 33854.2 -1242.7 7289.6 34652.4
       0.12 -0.04 26.1 28.8 72.4 -21.3 21.0
