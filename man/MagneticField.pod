=for comment $Id: d881c200a2a3ecb2ef8ec051c7bd048551f894be $
...
is the height above the ellipsoid in meters.  Alternatively, I<time> can
be given on the commend line as the argument to the I<-t> option, in
which case it should not be included on the input lines.
...
evaluate the field at I<time> instead of readig the time from the input
lines.
...
default magnetic path and name.  Use the B<-v> option to ascertain the
