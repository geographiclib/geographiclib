...
B<MagneticField> in times and positions on standard input and prints out
the magnetic field on standard output and its rate of change.
...
signal an error if I<time> lies I<tguard> years (default 100 yr) beyond
