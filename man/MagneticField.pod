...
The output consists of the following 7 items:
  ...
  the declination (the direction of the horizontal component of
    the field measure clockwise from north) in degrees,
  ...
  the north component for the field in nT,
...
B<MagneticField> computes the magnetic field using one of the following
models
