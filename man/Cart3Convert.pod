...
Geodetic coordinates, I<phi*> and I<lambda*>, with the north pole lying
on the I<X> axis, signified by B<-GX>.

=item 6.

Parametric coordinates, I<phi*'> and I<lambda*'>, with the north pole lying
on the I<X> axis, signified by B<-PX>.

=item 7.

Geocentric coordinates, I<phi*"> and I<lambda*">, with the north pole lying
on the I<X> axis, signified by B<-CX>.
...
If the B<-3> flag is given (this cannot be combined with B<-D>, the an
...
I<omega> I<alpha> to I<X>, I<Y>, I<Z> I<Vx>, I<Vy>, I<Vz> where [I<vx>,
I<vy>, I<vz>] is a unit vector lying in the surface of the ellipsoid.
...
include the direction I<alpha> in the calculation.  With the B<-r>
option, it is assumed that the vector [I<vx>, I<vy>, I<vz>] is tangent
to the surface of the ellipsoid.  This cannot be combined with B<-3>.
