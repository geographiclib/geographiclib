...
coorindates, a heading is given by the azimuth I<alpha> measured
...
cartesian points lying on the surface of the ellipsoid.
...
from standard input and the B<-r> option is ignored.
