=for comment $Id: 99180920845768cf62e2bed8f5aa23344e12977b $
...
line.)  Alternatively, : may be used to separate the various components.
Latitude is given first (unless the B<-w> option is given); however, on
