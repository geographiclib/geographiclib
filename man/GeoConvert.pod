=for comment $Id: b25bec75d0dcd6739f2ab78b0b930f02adddf232 $
...
is used (I<a> = 6378137m, I<f> = 1/298.257223563).
...
first by appending or prepending I<N> or I<S> to the latitude and I<E>
or I<W> to the longitude.  For example, the following are all equivalent
...
set the precision to I<prec> (default 0); I<prec> is the precision
...
I<prec> gives precision of the output with I<prec> = 0 giving 1m
precision, I<prec> = 3 giving 1mm precision, etc.  I<prec> is the number
...
choice beteen UTM and UPS and the UTM zone mirrors the input.  The B<-z>
...
B<GeoConvert> is a part of GeographicLib,
...
B<GeoConvert> was added to GeographicLib in 2009-01.
