...
B<GeodSolve> measures all angles in degrees, all lengths (I<s12>) in
...
The exact routines are covered in C. F. F. Karney,
I<Geodesics on an arbitrary ellipsoid of revolution>,
J. Geodesy 98, 4:1-14 (2024); DOI:
L<https://doi.org/10.1007/s00190-023-01813-2>.
