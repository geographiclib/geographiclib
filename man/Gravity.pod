...
compute the gravity disturbance <delta> = B<g> - B<gamma>, where
B<gamma> is the "normal" gravity due to the reference ellipsoid .  The
output consists of I<deltax> I<deltay> I<deltaz> (all in m/s^2), where
the I<x>, I<y>, and I<z> components are in easterly, northerly, and up
directions, respectively.  Note that I<deltax> = I<gx>, because
I<gammax> = 0.
