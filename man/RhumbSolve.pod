...
azimuth I<azi> along its length.  A point at a pole is treated as a
...
and prints the values of I<azi> I<s12> for the corresponding shortest
rhumb lines
...
By default, series expansions are used to compute a key ratio of
differences accurately.  The series are only accurate for |I<f>| E<lt>
0.01.  If B<-E> is supplied, the ratio is computed directly using exact
...
and conformal latitudes.  These are accurate for |I<f>| E<lt> 0.01.  If
