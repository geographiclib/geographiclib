...
(I<lat1>, I<lon1>) and (I<lat2>, I<lon2>) is called the rhumb line.
Its length is I<s12> and the rhumb line has a forward azimuth I<azi>
along its length.  The longitude becomes indeterminate when a rhumb
line passes through a pole, and B<RhumbSolve> reports NaNs for the
