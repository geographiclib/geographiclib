...
differences accurately.  The series are only accurate for |I<f>| E<lt>
0.02.  If B<-E> is supplied, the ratio is computed directly using exact
...
and conformal latitudes.  These are accurate for |I<f>| E<lt> 0.02.  If
the B<-E> option is supplied then the ratio of the differences will be
