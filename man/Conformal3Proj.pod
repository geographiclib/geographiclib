...
B<Conformal3Proj> [ B<-r> ]
[ B<-t> I<a> I<b> I<c> | B<-e> I<b> I<e2> I<k2> I<kp2> ]
[ B<-tx> I<ax> I<bx> I<cx> | B<-ex> I<bx> I<e2x> I<k2x> I<kp2x> ]
...
If either B<-tx> or B<-ex> is given, then this describes an target
ellipsoid onto which the points are conformally mapped via the Jacobi
projection.  In this case, the meridian convergence and the scale are
...
=item B<-tx> I<ax> I<bx> I<cx>

specify the target ellipsoid via its semiaxes.

=item B<-ex> I<bx> I<e2x> I<k2x> I<kp2x>
