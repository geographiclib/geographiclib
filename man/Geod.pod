...
I<f> E<lt> 0 for a prolate ellipsoid.  If I<f> E<gt> 1, the flattening
is set to 1/I<f>.  By default, the WGS84 ellipsoid is used, I<a> =
6378137m, I<f> = 1/298.257223563.
...
I<M21> I<S12>.  I<a12> is described in I<AUXILIARY SPHERE>.  The four
...
of digits after the decimal point for lengths.  For decimal degrees, the
number of digits after the decimal point is 5 + I<prec>.  For DMS
(degree, minute, seconds) output, the number of digits after the decimal
point in the seconds component is 1 + I<prec>.  The minimum value of
I<prec> is 0 and the maximum is 10.
