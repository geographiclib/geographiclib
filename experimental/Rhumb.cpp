...
#if GEOGRAPHICLIB_EXP_RHUMBAREA_ORDER == 4
...
#elif GEOGRAPHICLIB_EXP_RHUMBAREA_ORDER == 5
      static const real coeffs[] = {
        // Coefficients in matrix Q
...
#elif GEOGRAPHICLIB_EXP_RHUMBAREA_ORDER == 6
      static const real coeffs[] = {
        // Coefficients in matrix Q
...
#elif GEOGRAPHICLIB_EXP_RHUMBAREA_ORDER == 7
      static const real coeffs[] = {
        // Coefficients in matrix Q
...
#elif GEOGRAPHICLIB_EXP_RHUMBAREA_ORDER == 8
      static const real coeffs[] = {
        // Coefficients in matrix Q
...
#else
#error "Bad value for GEOGRAPHICLIB_EXP_RHUMBAREA_ORDER"
#endif
