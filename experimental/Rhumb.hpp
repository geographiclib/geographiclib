...
#if !defined(GEOGRAPHICLIB_EXP_RHUMB_HPP)
#define GEOGRAPHICLIB_EXP_RHUMB_HPP 1

#include <GeographicLib/Constants.hpp>
#include <vector>
#include "DAuxLatitude.hpp"

#if !defined(GEOGRAPHICLIB_EXP_RHUMBAREA_ORDER)
/**
 * The order of the series approximation used in rhumb area calculations.
 * GEOGRAPHICLIB_EXP_RHUMBAREA_ORDER can be set to one of [4, 5, 6, 7, 8].
 **********************************************************************/
#  define GEOGRAPHICLIB_EXP_RHUMBAREA_ORDER \
...
namespace experimental {
  ...
  private:
    ...
    static const int Lmax_ = GEOGRAPHICLIB_EXP_RHUMBAREA_ORDER;
...
#endif  // GEOGRAPHICLIB_EXP_RHUMB_HPP
