...
namespace GeographicLib {
    ...
    , _caps(caps | LATITUDE | AZIMUTH)
  {
    ...
    if (_caps & CAP_C1) {
      _aA1m1 = Geodesic30<real>::A1m1f(eps);
      Geodesic30<real>::C1f(eps, _cC1a);
      _bB11 = Geodesic30<real>::SinCosSeries(true, _ssig1, _csig1, _cC1a, nC1_);
    ...
    if (_caps & CAP_C1p)
      Geodesic30<real>::C1pf(eps, _cC1pa);

    if (_caps & CAP_C2) {
      _aA2m1 = Geodesic30<real>::A2m1f(eps);
      Geodesic30<real>::C2f(eps, _cC2a);
      _bB21 = Geodesic30<real>::SinCosSeries(true, _ssig1, _csig1, _cC2a, nC2_);
    }

    if (_caps & CAP_C3) {
      g.C3f(eps, _cC3a);
      _aA3c = -_f * _salp0 * g.A3f(eps);
      _bB31 = Geodesic30<real>::SinCosSeries(true, _ssig1, _csig1,
                                            _cC3a, nC3_-1);
    }
    ...
    if (_caps & CAP_C4) {
      ...
      _bB41 = Geodesic30<real>::SinCosSeries(false, _ssig1, _csig1,
                                             _cC4a, nC4_);
    }
  }
  ...
  const {
    ...
    if (outmask & (DISTANCE | REDUCEDLENGTH | GEODESICSCALE)) {
      if (arcmode)
        B12 = Geodesic30<real>::SinCosSeries(true, ssig2, csig2, _cC1a, nC1_);
    ...
    if (outmask & LONGITUDE) {
      lam12 = omg12 + _aA3c *
        ( sig12 +
          (Geodesic30<real>::SinCosSeries(true, ssig2, csig2, _cC3a, nC3_-1)
           - _bB31));
    ...
    if (outmask & (REDUCEDLENGTH | GEODESICSCALE)) {
      real
        ...
        B22 = Geodesic30<real>::SinCosSeries(true, ssig2, csig2, _cC2a, nC2_),
    ...
    if (outmask & AREA) {
      real
        B42 = Geodesic30<real>::SinCosSeries(false, ssig2, csig2, _cC4a, nC4_);
      real salp12, calp12;
