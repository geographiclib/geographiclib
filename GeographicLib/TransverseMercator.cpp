...
namespace GeographicLib {
  ...
  TransverseMercator::TransverseMercator(double a, double invf, double k0)
    ...
    , _h1 (_n*(_n*(_n*(_n*(_n*(384796*_n-382725)-6720)+932400)-1612800)+
	       1209600)/2419200)
    , _h1p(_n*(_n*(_n*(_n*(_n*(31564*_n-66675)+34440)+47250)-100800)+75600)/
	   151200)
    , _h2 (_n*_n*(_n*(_n*((1695744-1118711*_n)*_n-1174656)+258048)+80640)/
	   3870720)
    , _h2p(_n*_n*(_n*(_n*((863232-1983433*_n)*_n+748608)-1161216)+524160)/
	   1935360)
...
#elif TM_MAXPOW == 7
    , _a1 (_a/(1+_n)*(_n*_n*(_n*_n*(_n*_n+4)+64)+256)/256)
    , _h1 (_n*(_n*(_n*(_n*(_n*((6156736-5406467*_n)*_n-6123600)-107520)+
		       14918400)-25804800)+19353600)/38707200)
    , _h1p(_n*(_n*(_n*(_n*(_n*(_n*(1804025*_n+2020096)-4267200)+2204160)+
		       3024000)-6451200)+4838400)/9676800)
    , _h2 (_n*_n*(_n*(_n*(_n*(_n*(829456*_n-5593555)+8478720)-5873280)+
		      1290240)+403200)/19353600)
    , _h2p(_n*_n*(_n*(_n*(_n*(_n*(4626384*_n-9917165)+4316160)+3743040)-
		      5806080)+2620800)/9676800)
    , _h3 (_n*_n*_n*(_n*(_n*(_n*(9261899*_n+3564160)-2708640)-2557440)+
		     2056320)/58060800)
    , _h3p(_n*_n*_n*(_n*(_n*((26816480-67102379*_n)*_n+16265880)-21358080)+
		     7378560)/29030400)
    , _h4 (_n*_n*_n*_n*(_n*(_n*(14928352*_n-9132761)-1742400)+2176515)/
	   79833600)
    , _h4p(_n*_n*_n*_n*(_n*(_n*(155912000*_n+72618271)-85060800)+24532695)/
	   79833600)
    ...
    , _a1 (_a/(1+_n)*(_n*_n*(_n*_n*(_n*_n*(25*_n*_n+64)+256)+4096)+16384)/
	   16384)
    , _h1 (_n*(_n*(_n*(_n*(_n*(_n*(_n*(31777436*_n-37845269)+43097152)-
			       42865200)-752640)+104428800)-180633600)+
	       135475200)/270950400)
    , _h1p(_n*(_n*(_n*(_n*(_n*(_n*((37884525-75900428*_n)*_n+42422016)-
			       89611200)+46287360)+63504000)-135475200)+
	       101606400)/203212800)
    , _h2 (_n*_n*(_n*(_n*(_n*(_n*(_n*(24749483*_n+14930208)-100683990)+
			      152616960)-105719040)+23224320)+7257600)/
	   348364800)
    , _h2p(_n*_n*(_n*(_n*(_n*(_n*(_n*(148003883*_n+83274912)-178508970)+
			      77690880)+67374720)-104509440)+47174400)/
	   174182400)
    , _h3 (_n*_n*_n*(_n*(_n*(_n*((101880889-232468668*_n)*_n+39205760)-
			     29795040)-28131840)+22619520)/638668800)
    , _h3p(_n*_n*_n*(_n*(_n*(_n*(_n*(318729724*_n-738126169)+294981280)+
			     178924680)-234938880)+81164160)/319334400)
    , _h4 (_n*_n*_n*_n*(_n*(_n*(_n*(324154477*_n+1433121792.)-876745056)-
			    167270400)+208945440)/7664025600.)
    , _h4p(_n*_n*_n*_n*(_n*(_n*((14967552000.-40176129013.*_n)*_n+
				6971354016.)-8165836800.)+2355138720.)/
	   7664025600.)
    , _h5 (_n*_n*_n*_n*_n*(_n*(_n*(457888660*_n-312227409)-67920528)+
			   70779852)/2490808320.)
    , _h5p(_n*_n*_n*_n*_n*(_n*(_n*(10421654396.*_n+3997835751.)-4266773472.)+
			   1072709352.)/2490808320.)
    , _h6 (_n*_n*_n*_n*_n*_n*((-19841813847.*_n-3665348512.)*_n+3758062126.)/
	   116237721600.)
    , _h6p(_n*_n*_n*_n*_n*_n*(_n*(175214326799.*_n-171950693600.)+
