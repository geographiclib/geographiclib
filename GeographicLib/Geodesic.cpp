...
#define GEODESIC_CPP "$Id: Geodesic.cpp 6633 2009-06-01 10:06:43Z ckarney $"
...
namespace GeographicLib {
  ...
  void Geodesic::Lengths(double k1, double sig12,
  ...
  // integers of 10 digits or more to doubles (not necessary any more); (3)
  // change 1/4 to 1/4.0 (not necessary any more); (4) rudimentary
  // line-breaking.
