function [lat, lon, azi, rk] = eqdazimrev(lat0, lon0, x, y, ellipsoid)
%EQDAZIMREV  Reverse ellipsoidal equidistant azimuthal projection
%
%   [LAT, LON] = EQDAZIMREV(LAT0, LON0, X, Y)
%   [LAT, LON, AZI, RK] = EQDAZIMREV(LAT0, LON0, X, Y, ELLIPSOID)
%
%   performs the reverse ellipsoidal equidistant azimuthal projection of
...
%
%   See also EQDAZIMFWD, GEODRECKON, DEFAULTELLIPSOID.
