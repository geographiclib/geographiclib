...
%   cases:
%     * lat1 = -lat2 (with neither at a pole). If azi1 = azi2, the geodesic
%       is unique. Otherwise there are two geodesics and the second one is
%       obtained by setting [azi1,azi2] = [azi2,azi1]. (This occurs when
...
%       [-azi1,-azi2]. (This occurs when the lat2 is near -lat1 for prolate
%       ellipsoids.)
