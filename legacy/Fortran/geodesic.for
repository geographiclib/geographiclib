...
*! interface block given in geodesic.inc.
*!
...
*! vertices given by the areas lats and lons.  It returns the area in AA
*! and the perimeter in PP.  The polygon must be simple;
...
*! exceed of 180&deg;.)
*!
*! This is a transcription of the C++ function
