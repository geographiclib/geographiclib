...
echo cmake -G \'Visual Studio 10\' -D CMAKE_INSTALL_PREFIX=C:/pkg-vc10-x64/GeographicLib -D ENABLE_MATLAB=on .. > $WINDOWSBUILD/GeographicLib-$VERSION/BUILD-vc10-x64/config
