...
namespace GeographicLib {
  ...
  // The static "coeff" arrays in the following functions are generated by
  // Maxima and gives the coefficients of the Taylor expansions for the
  // geodesics.  The convention on the order of these coefficients is as
  // follows: ascending order in the trigonometric expansion, then powers of
  // eps in descending order, finally powers of n in descending order.  (For
  // some expansions, only a subset of levels occur.)  For each polynomial of
  // order n at the lowest level, the (n+1) coefficients of the polynomial are
  // followed by a divisor which is applied to the whole polynomial.  In this
  // way, the coefficients are expressible with no round off error.

  // The scale factor A1-1 = mean value of (d/dsigma)I1 - 1
  Math::real Geodesic::A1m1f(real eps) {
    // Generated by Maxima on 2015-05-05 18:08:12-04:00
#if GEOGRAPHICLIB_GEODESIC_ORDER/2 == 0
    static const real coeff[] = {
      // (1-eps)*A1-1, polynomial in eps2 of order 0
      0, 1,
    };
#elif GEOGRAPHICLIB_GEODESIC_ORDER/2 == 1
    static const real coeff[] = {
...
#error "Bad value for GEOGRAPHICLIB_GEODESIC_ORDER"
  ...
  void Geodesic::C1f(real eps, real c[]) {
    // Generated by Maxima on 2015-05-05 18:08:12-04:00
#if GEOGRAPHICLIB_GEODESIC_ORDER == 0
    static const real coeff[] = {
    };
#elif GEOGRAPHICLIB_GEODESIC_ORDER == 1
    static const real coeff[] = {
      // C1[1]/eps^1, polynomial in eps2 of order 0
      -1, 2,
    };
#elif GEOGRAPHICLIB_GEODESIC_ORDER == 2
    static const real coeff[] = {
      // C1[1]/eps^1, polynomial in eps2 of order 0
      -1, 2,
...
#elif GEOGRAPHICLIB_GEODESIC_ORDER == 3
    static const real coeff[] = {
...
#elif GEOGRAPHICLIB_GEODESIC_ORDER == 1
    static const real coeff[] = {
      // C1p[1]/eps^1, polynomial in eps2 of order 0
      1, 2,
    };
#elif GEOGRAPHICLIB_GEODESIC_ORDER == 2
    static const real coeff[] = {
...
#if GEOGRAPHICLIB_GEODESIC_ORDER/2 == 0
    static const real coeff[] = {
      // A2/(1-eps)-1, polynomial in eps2 of order 0
      0, 1,
    };
#elif GEOGRAPHICLIB_GEODESIC_ORDER/2 == 1
    static const real coeff[] = {
...
#elif GEOGRAPHICLIB_GEODESIC_ORDER == 1
    static const real coeff[] = {
      // C2[1]/eps^1, polynomial in eps2 of order 0
      1, 2,
    };
#elif GEOGRAPHICLIB_GEODESIC_ORDER == 2
    static const real coeff[] = {
...
#elif GEOGRAPHICLIB_GEODESIC_ORDER == 2
    static const real coeff[] = {
      // A3, coeff of eps^1, polynomial in n of order 0
      -1, 2,
      // A3, coeff of eps^0, polynomial in n of order 0
      1, 1,
    };
...
#elif GEOGRAPHICLIB_GEODESIC_ORDER == 2
    static const real coeff[] = {
    // C3[1], coeff of eps^1, polynomial in n of order 0
    1, 4,
    };
#elif GEOGRAPHICLIB_GEODESIC_ORDER == 3
    static const real coeff[] = {
...
#elif GEOGRAPHICLIB_GEODESIC_ORDER == 1
    static const real coeff[] = {
      // C4[0], coeff of eps^0, polynomial in n of order 0
      2, 3,
    };
#elif GEOGRAPHICLIB_GEODESIC_ORDER == 2
    static const real coeff[] = {
      // C4[0], coeff of eps^1, polynomial in n of order 0
      -1, 5,
      // C4[0], coeff of eps^0, polynomial in n of order 1
      -4, 10, 15,
      // C4[1], coeff of eps^1, polynomial in n of order 0
      1, 45,
    };
#elif GEOGRAPHICLIB_GEODESIC_ORDER == 3
    static const real coeff[] = {
