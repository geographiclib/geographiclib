...
#if GEOGRAPHICLIB_RHUMBAREA_ORDER == 0
    static const real coeff[] = {
      // R[0]/n^0, polynomial in n of order 0
      0, 1,
    };  // count = 2
#elif GEOGRAPHICLIB_RHUMBAREA_ORDER == 1
    static const real coeff[] = {
      // R[0]/n^0, polynomial in n of order 1
      1, 0, 3,
      // R[1]/n^1, polynomial in n of order 0
      -1, 3,
    };  // count = 5
#elif GEOGRAPHICLIB_RHUMBAREA_ORDER == 2
    static const real coeff[] = {
      // R[0]/n^0, polynomial in n of order 2
      -16, 15, 0, 45,
      // R[1]/n^1, polynomial in n of order 1
      22, -15, 45,
      // R[2]/n^2, polynomial in n of order 0
      -2, 15,
    };  // count = 9
#elif GEOGRAPHICLIB_RHUMBAREA_ORDER == 3
    static const real coeff[] = {
      // R[0]/n^0, polynomial in n of order 3
      131, -336, 315, 0, 945,
      // R[1]/n^1, polynomial in n of order 2
      -356, 462, -315, 945,
      // R[2]/n^2, polynomial in n of order 1
      106, -42, 315,
      // R[3]/n^3, polynomial in n of order 0
      -31, 315,
    };  // count = 14
#elif GEOGRAPHICLIB_RHUMBAREA_ORDER == 4
    static const real coeff[] = {
...
#error "Bad value for GEOGRAPHICLIB_RHUMBAREA_ORDER"
    ...
    real d = 1;
    int o = 0;
    // R[0] is just an integration constant.  It won't be used...
    ...
    if (!(o == sizeof(coeff) / sizeof(real)))
      throw GeographicErr("coeff mixup in Rhumb");
  }
