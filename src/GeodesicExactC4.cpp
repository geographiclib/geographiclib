...
namespace GeographicLib {
  ...
  // 831281402884796906843926125 = 0x2af9eaf25d149c52a73ee6d = 184581550685 *
  // 2^52 + 0x149c52a73ee6d which is less than 2^90.  Both a and b are less
  // that 2^52 and so are exactly representable by doubles; then the
  // computation of the full double coefficient involves only a single rounding
  // operation.  (Actually integers up to and including 2^53 can be represented
  // exactly as doubles.  Limiting b to 52 bits allows it to be represented in
  // 13 digits in hex.)
  ...
  void GeodesicExact::C4coeff() {
    ...
    static const real coeff[] = {
      ...
      19420000,-9609488,7145551,real(87882790905LL),
      ...
      61416608,15713412,real(0x35f1be97217LL),
      // C4[2], coeff of eps^21, polynomial in n of order 2
      1053643008,-709188480,real(436906360),real(0x18f301bf7f77LL),
      ...
      -31178752,16812224,real(0x192c8c2464fLL),
      ...
      -16545868800LL,-real(26558972160LL),-real(43799006720LL),
      ...
      2135226368,598833664,real(0x1358168b64fd9LL),
      // C4[4], coeff of eps^21, polynomial in n of order 2
      23101878272LL,-26986989568LL,real(11760203136LL),real(0x4f869592664b5LL),
      ...
      469241266176LL,real(0x10545cac800LL),real(0x2adf04bd000LL),
      ...
      31160807424LL,real(61322082304LL),3864763LL<<15,real(276675840000LL),
      real(646157094912LL),real(0x17cd936d800LL),real(0x429614e2000LL),
      real(0xd3b41886800LL),real(0x31f7c0917000LL),real(0xf21fb6ecf800LL),
      real(0x6ee892beec000LL),real(0x889688d5b28800LL),
      ...
      1806732800,3354817536LL,6474635776LL,13058088960LL,real(27705484800LL),
      real(62364503040LL),real(150565728768LL),real(395569133568LL),
      real(0x10ca075be00LL),real(0x37f6c332400LL),real(0xdf0e61c4a00LL),
      real(0x47dfa8095000LL),real(0x236014b495600LL),real(0x2f60ae04237c00LL),
      ...
      -104833024,39440128,real(0x62c2748ec71LL),
      // C4[5], coeff of eps^21, polynomial in n of order 2
      -45133008896LL,5079242752LL,1557031040,real(0x4f869592664b5LL),
      ...
      -28322922496LL,-real(77318326272LL),-real(233990443008LL),
      ...
      -10859667456LL,-26129596416LL,-67565166592LL,-190510645248LL,
      -real(597656199168LL),-real(65543051LL<<15),-real(0x869fe272000LL),
      -real(0x2f027b014000LL),-real(0x19275e39a6000LL),
      ...
      -392933376,-865908736,-2015985664,-5002905600LL,-13385551872LL,
      -real(39200544768LL),-128292691968LL,-real(483473385472LL),
      -real(0x1ffab8af000LL),-real(0xbdf5200f800LL),-real(0x6d0cb854c000LL),
      -real(0xacf22c5668800LL),real(0xfa276dd8697000LL),
      -real(0x6c92e41ed151800LL),real(0x18f8d3300c4da000LL),
      -real(0x382fdb2c1baea800LL),real(0x4f13f21826f5d000LL),
      -real(0x3d1b0c8706d53800LL),real(0x131873ea3222a180LL),
      reale(236543,0x59e86fb479711LL),
      // C4[6], coeff of eps^23, polynomial in n of order 0
      20016128,real(0x45dab658805LL),
      // C4[6], coeff of eps^22, polynomial in n of order 1
      12387831808LL,4069857792LL,real(0x1b45118f2c973bLL),
      // C4[6], coeff of eps^21, polynomial in n of order 2
      828267LL<<17,-178562334720LL,52104335360LL,real(0x22cae1700cc0f3LL),
      ...
      9867LL<<18,8045019136LL,854413LL<<15,6856031LL<<14,8304289LL<<16,
      real(0x3232f0a4000LL),real(0x1ec960fb8000LL),real(0x3439f07dcc000LL),
      -real(0x50f0148aea0000LL),real(0x25bf6de530f4000LL),
      -real(0x9635a567bcf8000LL),real(0x1735ee17e1e1c000LL),
      -real(0x25a38fef60750000LL),real(0x2834884b55944000LL),
      -real(0x1b3dfda8c79a8000LL),real(0xa981b88bf66c000LL),
      -real(0x1cc16f4e99cdc00LL),reale(93183,0xbe91de6de243dLL),
      // C4[6], coeff of eps^6, polynomial in n of order 17
      169275392,7007<<16,1348931584,4358086656LL,15819288576LL,66522136576LL,
      real(339738054656LL),real(0x214230b6000LL),real(0x15d36ff77000LL),
      ...
      real(0xf46c321c1b54e00LL),reale(279551,0x3bb59b49a6cb7LL),
      // C4[7], coeff of eps^23, polynomial in n of order 0
      383798272,real(0x7ee24536c1115LL),
      // C4[7], coeff of eps^22, polynomial in n of order 1
      -133717557248LL,34096398336LL,real(0x1f771442bd4c09LL),
      // C4[7], coeff of eps^21, polynomial in n of order 2
      -real(197998999LL<<19),-0x129b18c0000LL,-real(541336621056LL),
      ...
      -927214993408LL,-real(95481295LL<<16),-real(249804765LL<<18),
      ...
      -12531793920LL,-55567712256LL,-299357700096LL,-0x1eeb4700000LL,
      -real(89791009LL<<18),-real(1389164665LL<<19),real(79467759189LL<<18),
      -real(86766818957LL<<21),real(0xbfc5c91f6ec0000LL),
      -real(0x487b27f822fLL<<19),real(0x4a699e0854c40000LL),
      -real(0x69d85e75b6dLL<<20),real(0x66f7a9fb575c0000LL),
      -real(0x828d4038ea5LL<<19),real(0x60dc69748cdLL<<18),
      -real(0x3f90a5347c68800LL),reale(322559,0x1d82c6ded425dLL),
      // C4[7], coeff of eps^7, polynomial in n of order 16
      -149946368,-529858560,-2113011712,-9810411520LL,-55628267520LL,
      -418139144192LL,-real(37701755LL<<17),-real(0x95a9db330000LL),
      real(9764754545LL<<19),-real(0xaf0fe765fd0000LL),
      ...
      7579<<15,real(0x4f56c0c24f87LL),
      // C4[8], coeff of eps^22, polynomial in n of order 1
      -0x32ad0a00000LL,-real(23648625LL<<16),real(0x38232f25bccb5275LL),
      // C4[8], coeff of eps^21, polynomial in n of order 2
      9646043LL<<20,-real(24019457LL<<19),real(74048359LL<<15),
      ...
      -0x1a1695600000LL,-real(1155605701LL<<23),real(11263093395LL<<21),
      ...
      1140139LL<<21,9315711LL<<23,-real(1126319139LL<<21),
      ...
      54009LL<<20,849303LL<<19,2623117LL<<21,real(364892913LL<<19),
      -real(5919882885LL<<20),real(0xdd0128d3580000LL),
      ...
      2295<<17,5831<<18,72709LL<<17,151011LL<<19,7936467LL<<17,
      real(147906885LL<<18),-real(0x4d5c1f23e0000LL),real(14228642337LL<<20),
      -real(697203474513LL<<17),real(0x51fe4e56b0c0000LL),
      -real(0xeb59f3d2e860000LL),real(0x3e0c14100a1LL<<19),
      -real(0x305340db42ea0000LL),real(0xd6c75923d41LL<<18),
      -real(0x2452a78bb4ce0000LL),real(0xa981b88bf66c000LL),
      reale(365566,0xff4ff27401803LL),
      // C4[9], coeff of eps^23, polynomial in n of order 0
      -1494646784,real(0xa0b835899f381LL),
      // C4[9], coeff of eps^22, polynomial in n of order 1
      -0x8e52aa00000LL,real(25498473LL<<16),real(0x8f68f0ea15ed989LL),
      ...
      -61641588736LL,-(283917LL<<23),real(41246777LL<<21),
      ...
      -1693450240,-15410397184LL,-222858051584LL,-real(17534055LL<<19),
      real(342711075LL<<20),-real(8430692445LL<<19),real(7306600119LL<<22),
      -real(270344204403LL<<19),real(450573674005LL<<20),
      -real(0x20c896b3e69LL<<19),real(0xfa29e850f7LL<<21),
      -real(0x5aaf3103bffLL<<19),real(0x3002653e387LL<<20),
      -real(0x3f2b92b02f5LL<<19),real(0x914a9e2ed338000LL),
      reale(408574,0xe11d1e092eda9LL),
      // C4[10], coeff of eps^23, polynomial in n of order 0
      137<<21,real(0x8757c14b789bLL),
      // C4[10], coeff of eps^22, polynomial in n of order 1
      -0x1196b300000LL,-883938951168LL,real(0x9e817610332f06fLL),
      ...
      46189LL<<20,522291LL<<22,-real(90008149LL<<20),real(613691925LL<<21),
      -real(9499950999LL<<20),real(6182507793LL<<23),-real(187536069721LL<<20),
      real(270344204403LL<<21),-real(0x11a7161219bLL<<20),
      real(533756506129LL<<22),-real(0x2a7db4d305dLL<<20),
      real(0x159e458acd1LL<<21),-real(0x1bcb7dfb99fLL<<20),
      real(0x7e5725605ea0000LL),reale(451582,0xc2ea499e5c34fLL),
      // C4[11], coeff of eps^23, polynomial in n of order 0
      -(7309LL<<21),real(0x2c95e8ad321065LL),
      // C4[11], coeff of eps^22, polynomial in n of order 1
      -(118877LL<<30),1675947LL<<23,real(0x7759dcb5574d50a7LL),
      // C4[11], coeff of eps^21, polynomial in n of order 2
      -(9105745LL<<24),-real(49846181LL<<23),-real(2866583251LL<<18),
      ...
      735471LL<<25,-real(44046541LL<<23),real(188198857LL<<24),
      ...
      173LL<<24,real(0x88d5e64011771LL),
      // C4[12], coeff of eps^22, polynomial in n of order 1
      -(163369LL<<28),-(266903LL<<29),reale(14529,0xb09bccfe817bfLL),
      ...
      9134109LL<<27,real(1642561735LL<<26),real(58767343LL<<28),
      ...
      -(34717LL<<24),real(0x4013d857859e5adLL),
      // C4[13], coeff of eps^22, polynomial in n of order 1
      -(52837LL<<30),101283LL<<25,real(0x39b1009e5dec691dLL),
      ...
      -real(38160201LL<<32),real(20133099LL<<33),-(10736915LL<<32),
      8118075LL<<27,reale(580606,0x6851cc5de4441LL),
      ...
      -real(832792389LL<<26),-(13821619LL<<27),real(313960329LL<<26),
      ...
      -(7540351LL<<29),-real(836978961LL<<24),reale(580606,0x6851cc5de4441LL),
      ...
      -real(363925371LL<<29),real(41606327LL<<30),1574359LL<<29,
      ...
      -(11003LL<<27),real(0x6a44bb11ad2310dLL),
      // C4[15], coeff of eps^22, polynomial in n of order 1
      -(28003LL<<36),3549LL<<30,reale(39213,0x11a47a8f8b3bdLL),
      // C4[15], coeff of eps^21, polynomial in n of order 2
      1243LL<<38,2249LL<<37,-(577583LL<<28),reale(5601,0xddf2ecefef51bLL),
      // C4[15], coeff of eps^20, polynomial in n of order 3
      -(28101LL<<40),24493LL<<39,-(1645LL<<40),-(318801LL<<29),
      reale(39213,0x11a47a8f8b3bdLL),
      // C4[15], coeff of eps^19, polynomial in n of order 4
      1359187LL<<38,-(4447191LL<<36),-(433293LL<<37),1982883LL<<36,
      -real(164770109LL<<28),reale(666622,0x2bec23883ef8dLL),
      // C4[15], coeff of eps^18, polynomial in n of order 5
      -(6907451LL<<36),1332757LL<<38,-(2401277LL<<36),253189LL<<37,26273LL<<36,
      -(1574359LL<<30),reale(95231,0xbd21bbeee46cbLL),
      // C4[15], coeff of eps^17, polynomial in n of order 6
      real(60642045LL<<33),-real(48519929LL<<32),-(5596337LL<<34),
      ...
      -real(18042031LL<<36),real(49556941LL<<34),-(12180567LL<<35),
      7540351LL<<34,-real(278992987LL<<26),reale(222207,0x63f9612d6a52fLL),
      // C4[15], coeff of eps^15, polynomial in n of order 8
      5892945LL<<35,-real(106383165LL<<32),real(102040995LL<<33),
      ...
      -(1LL<<31),real(0x5f43434b6401e1LL),
      // C4[16], coeff of eps^22, polynomial in n of order 1
      4571LL<<36,-(33945LL<<32),reale(5963,0x471b5f51fec25LL),
      // C4[16], coeff of eps^21, polynomial in n of order 2
      24269LL<<36,-(5831LL<<35),-(11703LL<<31),reale(5963,0x471b5f51fec25LL),
      // C4[16], coeff of eps^20, polynomial in n of order 3
      -(224895LL<<36),-(32277LL<<37),111531LL<<36,-(139825LL<<34),
      reale(41742,0xf1bf9b3df7503LL),
      // C4[16], coeff of eps^19, polynomial in n of order 4
      978405LL<<37,-(1674813LL<<35),162197LL<<36,29281LL<<35,-(297087LL<<31),
      reale(41742,0xf1bf9b3df7503LL),
      // C4[16], coeff of eps^18, polynomial in n of order 5
      -(15263501LL<<36),-(3038189LL<<38),real(24413445LL<<36),
      -(10587549LL<<37),10822455LL<<36,-real(41181917LL<<32),
      reale(709630,0xdb94f1d6c533LL),
      // C4[16], coeff of eps^17, polynomial in n of order 6
      -(7565085LL<<36),16306961LL<<35,-(3541967LL<<37),9518487LL<<35,
      -(2301919LL<<36),1408637LL<<35,-(3231579LL<<31),
      reale(101375,0xb8d15471eae75LL),
      ...
      -(1121LL<<31),real(0x6ef59e61feaaea7LL),
      // C4[17], coeff of eps^22, polynomial in n of order 1
      -(59LL<<37),-(309LL<<32),real(0x14ce0db25fc00bf5LL),
      // C4[17], coeff of eps^21, polynomial in n of order 2
      -(10703LL<<36),30413LL<<35,-(148003LL<<31),reale(6324,0xb043d1b40e32fLL),
      // C4[17], coeff of eps^20, polynomial in n of order 3
      -(177777LL<<38),15715LL<<39,4277LL<<38,-(68103LL<<33),
      reale(44272,0xd1dabbec63649LL),
      // C4[17], coeff of eps^19, polynomial in n of order 4
      -(407783LL<<37),2775087LL<<35,-(1157751LL<<36),1167621LL<<35,
      -(4428011LL<<31),reale(44272,0xd1dabbec63649LL),
      // C4[17], coeff of eps^18, polynomial in n of order 5
      1580535LL<<37,-(334719LL<<39),882049LL<<37,-(210231LL<<38),127323LL<<37,
      -(580027LL<<32),reale(44272,0xd1dabbec63649LL),
      // C4[17], coeff of eps^17, polynomial in n of order 6
      801009LL<<36,-(2422805LL<<35),785323LL<<37,-(3419955LL<<35),
      1485435LL<<36,-(1740081LL<<35),7540351LL<<31,
      reale(44272,0xd1dabbec63649LL),
      // C4[18], coeff of eps^23, polynomial in n of order 0
      -(89LL<<35),real(0x3351994085c8a607LL),
      // C4[18], coeff of eps^22, polynomial in n of order 1
      763LL<<36,-(1809LL<<33),real(0x15fe66403955fe03LL),
      // C4[18], coeff of eps^21, polynomial in n of order 2
      91LL<<39,35LL<<38,-(235LL<<34),real(0x15fe66403955fe03LL),
      // C4[18], coeff of eps^20, polynomial in n of order 3
      667755LL<<37,-(269591LL<<38),268793LL<<37,-(508305LL<<34),
      reale(46802,0xb1f5dc9acf78fLL),
      // C4[18], coeff of eps^19, polynomial in n of order 4
      -(51319LL<<40),132867LL<<38,-(31255LL<<39),18753LL<<38,-(42441LL<<34),
      reale(15600,0xe5fc9ede45285LL),
      // C4[18], coeff of eps^18, polynomial in n of order 5
      -(1198615LL<<36),378917LL<<38,-(1619009LL<<36),693861LL<<37,
      -(806379LL<<36),1740081LL<<33,reale(46802,0xb1f5dc9acf78fLL),
      // C4[19], coeff of eps^23, polynomial in n of order 0
      -(983LL<<35),real(0x3617bd362c26857dLL),
      // C4[19], coeff of eps^22, polynomial in n of order 1
      1LL<<46,-(189LL<<37),reale(2596,0x737a284739077LL),
      // C4[19], coeff of eps^21, polynomial in n of order 2
      -(473LL<<40),467LL<<39,-(3525LL<<34),real(0x172ebece12ebf011LL),
      // C4[19], coeff of eps^20, polynomial in n of order 3
      2379LL<<41,-(553LL<<42),329LL<<41,-(2961LL<<35),
      reale(2596,0x737a284739077LL),
      // C4[19], coeff of eps^19, polynomial in n of order 4
      2405LL<<41,-(10101LL<<39),4277LL<<40,-(4935LL<<39),42441LL<<34,
      reale(2596,0x737a284739077LL),
      // C4[20], coeff of eps^23, polynomial in n of order 0
      -(1LL<<38),real(0x1f5feefdb1f0c4fLL),
      // C4[20], coeff of eps^22, polynomial in n of order 1
      379LL<<42,-(357LL<<40),reale(2729,0x9a383778d2ed9LL),
      // C4[20], coeff of eps^21, polynomial in n of order 2
      -(249LL<<43),147LL<<42,-(329LL<<38),reale(2729,0x9a383778d2ed9LL),
      // C4[20], coeff of eps^20, polynomial in n of order 3
      -(4797LL<<40),2009LL<<41,-(2303LL<<40),4935LL<<37,
      reale(2729,0x9a383778d2ed9LL),
      // C4[21], coeff of eps^23, polynomial in n of order 0
      -(1327LL<<38),reale(2862,0xc0f646aa6cd3bLL),
      // C4[21], coeff of eps^22, polynomial in n of order 1
      11LL<<44,-(49LL<<39),real(0x3ba4052178e24469LL),
      // C4[21], coeff of eps^21, polynomial in n of order 2
      473LL<<43,-(539LL<<42),2303LL<<38,reale(2862,0xc0f646aa6cd3bLL),
      // C4[22], coeff of eps^23, polynomial in n of order 0
      -(1LL<<41),real(0x5ac8f5f3162ebfdLL),
      // C4[22], coeff of eps^22, polynomial in n of order 1
      -(23LL<<43),49LL<<40,real(0x1105ae1d9428c3f7LL),
      // C4[23], coeff of eps^23, polynomial in n of order 0
      1LL<<41,real(0xc5e28ed2c935abLL),
    };  // count = 2900
    ...
    static const real coeff[] = {
      ...
      22113584,5520955,real(0xf784431927LL),
      ...
      76231168,19985680,real(0x958a9334879LL),
      // C4[3], coeff of eps^24, polynomial in n of order 2
      969805824,-756467712,427576864,real(0x33a763b318f5LL),
      ...
      74207744,real(0x377b3e1aa351LL),
      // C4[4], coeff of eps^25, polynomial in n of order 1
      -85649408,42776448,real(0x7a5a1b59863LL),
      ...
      19006687232LL,real(5473719680LL),real(0x1580fd4afdbe65LL),
      ...
      -57693732864LL,-118378242048LL,-254261280768LL,-real(575562375168LL),
      -0x142709a0000LL,-real(0x341c17b2000LL),-real(0x92ee7ecc000LL),
      -real(0x1ccf17876000LL),-real(0x6786d9e38000LL),-real(0x1bdf19e19a000LL),
      -real(0x9bb8377424000LL),-real(0x5352681ef5e000LL),
      -real(0x79ce0dfd0cd0000LL),reale(2563,0x29027cc1fe000LL),
      -reale(15917,0xface8c747c000LL),reale(51375,0x61bf7d963a000LL),
      -reale(99436,0x390f87b768000LL),reale(119998,0xa6d5e6f116000LL),
      -reale(88555,0x279c7be1d4000LL),reale(36577,0x210e8c3652000LL),
      -reale(6477,0x332fe8d449300LL),reale(12536797,0x9d1f205d24685LL),
      // C4[5], coeff of eps^5, polynomial in n of order 21
      -2537256960LL,-4922368000LL,-9913649152LL,-20825468928LL,
      -real(45893163008LL),-106847240192LL,-real(265153996800LL),
      -real(709434249216LL),-real(0x1e3bc54b800LL),-real(0x62f2289a000LL),
      -real(0x174e12bf8800LL),-real(0x69ee83c3b000LL),-real(0x2753bfa335800LL),
      -real(0x1693a2298bc000LL),-real(0x23ce232de3a2800LL),
      real(0x33ca29bdcdd43000LL),-reale(5754,0x693a6155df800LL),
      reale(21176,0x3b8f28c122000LL),-reale(47646,0x86021bb28c800LL),
      reale(67058,0x11f0010e41000LL),-reale(51817,0x997f46a249800LL),
      reale(16192,0xfff7c612b6f80LL),reale(12536797,0x9d1f205d24685LL),
      // C4[6], coeff of eps^26, polynomial in n of order 0
      71266816,real(0x75209f8d91abLL),
      // C4[6], coeff of eps^25, polynomial in n of order 1
      -1010843648,365122560,real(0x64173937d043LL),
      ...
      7458340864LL,560703LL<<15,48303816704LL,522951LL<<18,
      real(426386014208LL),real(45283889LL<<15),real(0x56a252ac000LL),
      real(440127317LL<<16),real(0xa648bd1f4000LL),real(0x65fb114118000LL),
      real(0xacffeca0b3c000LL),-real(0x860da206139LL<<17),
      real(0x7d0a1c0732284000LL),-reale(7961,0x1b3e7a1f58000LL),
      reale(19682,0xa4af1c3bcc000LL),-reale(31917,0xccc8ef8390000LL),
      reale(34094,0x3798b7b14000LL),-reale(23101,0x583f152fc8000LL),
      reale(8983,0xdb34fa045c000LL),-real(0x5f40c0b45d798c00LL),
      reale(4938738,0x74330cbfd80a1LL),
      // C4[6], coeff of eps^6, polynomial in n of order 20
      651542528,1480134656,3538968576LL,8971595776LL,371371LL<<16,
      real(71493373952LL),real(230978592768LL),real(838422294528LL),
      real(0x334e2804000LL),real(0x106060339000LL),real(0x6e2b415ae000LL),
      real(0x484c62e3a3000LL),real(0x848c0aa1558000LL),
      ...
      9763<<15,real(0x75209f8d91abLL),
      // C4[7], coeff of eps^25, polynomial in n of order 1
      239317LL<<16,5250319360LL,real(0x4082f7e0f93b2fLL),
      ...
      -(1386231LL<<24),-real(109742265LL<<20),-real(354075457LL<<21),
      ...
      -607647105024LL,-0x209c2b00000LL,-real(0x8adb5490000LL),
      ...
      -16500916224LL,-51019251712LL,-(41393LL<<22),-664185077760LL,
      -0x2adb4f80000LL,-real(60523827LL<<18),-real(107394483LL<<20),
      -real(4758923477LL<<18),-real(73625727245LL<<19),
      ...
      -307560448,-843448320,-2483486720LL,-7947157504LL,-28082503680LL,
      -111989620736LL,-519951810560LL,-0x2ae74440000LL,-real(338155741LL<<16),
      -real(0xee3402ee0000LL),-real(0x1efc2a618f0000LL),
      real(517531990885LL<<19),-real(0x243e4ae81d610000LL),
      reale(3081,0xb7f72703e0000LL),-reale(10639,0x4442fa8130000LL),
      reale(25534,4122358181LL<<18),-reale(43524,0x45cc2f5650000LL),
      reale(51336,0x52534b86a0000LL),-reale(35935,0x6cd3e81170000LL),
      reale(10668,0x544ee8e52d400LL),reale(17095633,0x1c132c21ebd41LL),
      // C4[8], coeff of eps^26, polynomial in n of order 0
      1703<<17,real(0x7c72a9866ac5bLL),
      // C4[8], coeff of eps^25, polynomial in n of order 1
      -185838075904LL,727155LL<<16,real(0x491cf6cbc520f1LL),
      ...
      53199LL<<25,4832235LL<<21,real(18086833LL<<22),real(422991569LL<<21),
      real(3456128781LL<<23),-real(417864400569LL<<21),
      ...
      47583LL<<19,12411LL<<23,964865LL<<19,2862477LL<<20,real(45013059LL<<19),
      real(139025201LL<<21),real(19339324389LL<<19),-real(313753792905LL<<20),
      ...
      1053<<18,7293<<17,1749LL<<21,121635LL<<17,309043LL<<18,3853577LL<<17,
      8003583LL<<19,real(420632751LL<<17),real(7839064905LL<<18),
      -real(550302356331LL<<17),real(754118043861LL<<20),
      -real(0x433703efa18a0000LL),reale(4345,0xa637f297c0000LL),
      -reale(12473,0x9f7aaa1be0000LL),reale(26308,41230677LL<<19),
      -reale(40979,0xc6d64da720000LL),reale(45533,1464249973LL<<18),
      -reale(30801,0xcafec6ea60000LL),reale(8983,0xdb34fa045c000LL),
      reale(19375050,0xdb8d32044f89fLL),
      // C4[9], coeff of eps^26, polynomial in n of order 0
      3679<<17,real(0xf744df0e6c69LL),
      // C4[9], coeff of eps^25, polynomial in n of order 1
      -51213500416LL,-22070231040LL,real(0x19892cc90d5217fLL),
      ...
      -(893LL<<25),-(92625LL<<21),-(399779LL<<22),-0x14cc9c600000LL,
      -real(105333207LL<<23),real(15302554267LL<<21),-real(86594321625LL<<22),
      real(0xfe4052cb09LL<<21),-reale(2108,118544893LL<<24),
      reale(6191,505418439LL<<21),-reale(13344,231933903LL<<22),
      reale(21384,2064906293LL<<21),-reale(25319,426528669LL<<23),
      reale(21525,1826875827LL<<21),-reale(12380,255070469LL<<22),
      reale(4285,1002542497LL<<21),-real(0x29d9aac7ec250000LL),
      reale(7218156,0x33ad12a23bbffLL),
      // C4[9], coeff of eps^9, polynomial in n of order 17
      -508035072,-(285LL<<23),-13198950400LL,-89752862720LL,-816751050752LL,
      -0xabe12e00000LL,-real(929304915LL<<19),real(18163686975LL<<20),
      -real(446826699585LL<<19),real(387249806307LL<<22),
      -real(0xd080dd307cfLL<<19),reale(5560,386556505LL<<20),
      -reale(13900,1932782525LL<<19),reale(26517,756597539LL<<21),
      -reale(38450,1381788619LL<<19),reale(40711,4015921907LL<<20),
      -reale(26784,1441242297LL<<19),reale(7700,0x72bfb1ba98000LL),
      reale(21654468,0x9b0737e6b33fdLL),
      // C4[10], coeff of eps^26, polynomial in n of order 0
      -1325662208,real(0x10edb70f760db7LL),
      // C4[10], coeff of eps^25, polynomial in n of order 1
      -(4901LL<<25),14157LL<<21,real(0x4082f7e0f93b2fLL),
      // C4[10], coeff of eps^24, polynomial in n of order 2
      -(8688787LL<<25),-(2064227LL<<24),-(9250461LL<<21),
      ...
      259293LL<<22,1935549LL<<23,real(164593143LL<<22),-real(1654671183LL<<24),
      real(83533307473LL<<22),-real(296200453241LL<<23),
      reale(2600,89083243LL<<22),-reale(8792,113023813LL<<25),
      reale(22203,397075141LL<<22),-reale(42668,107392175LL<<23),
      reale(62615,179754463LL<<22),-reale(69317,125076421LL<<24),
      reale(56036,868613689LL<<22),-reale(31065,284420581LL<<23),
      reale(10475,628806483LL<<22),-real(0x6470cd13038c0000LL),
      reale(23933886,0x5a813dc916f5bLL),
      // C4[10], coeff of eps^10, polynomial in n of order 16
      133LL<<24,15675LL<<20,77539LL<<21,2448017LL<<20,real(27681423LL<<22),
      -real(4770431897LL<<20),real(32525672025LL<<21),
      ...
      611LL<<23,real(0xe6baee73ea363LL),
      // C4[11], coeff of eps^25, polynomial in n of order 1
      -(76597LL<<26),-0x30085e00000LL,real(0x477bca00497fe9bfLL),
      // C4[11], coeff of eps^24, polynomial in n of order 2
      5977365LL<<29,-(9705069LL<<28),real(85309807LL<<22),
      ...
      -(2670507LL<<26),real(235653561LL<<25),-real(820617391LL<<27),
      ...
      -(3933LL<<23),-(33649LL<<24),-(3312023LL<<23),real(38979963LL<<25),
      -real(2334466673LL<<23),real(9974539421LL<<24),-real(115419670443LL<<23),
      real(61272170729LL<<26),-reale(2977,381931269LL<<23),
      reale(7656,260966955LL<<24),-reale(15739,178079295LL<<23),
      reale(25923,81221929LL<<25),-reale(33768,486785817LL<<23),
      reale(33232,239529529LL<<24),-reale(20951,91935571LL<<23),
      reale(5892,8880483819LL<<18),reale(26213304,0x19fb43ab7aab9LL),
      // C4[12], coeff of eps^26, polynomial in n of order 0
      -(1LL<<33),real(0x2f0618f20f09a7LL),
      // C4[12], coeff of eps^25, polynomial in n of order 1
      -(62273LL<<28),123651LL<<24,real(0x19e65bbd524850fbLL),
      ...
      198835LL<<25,-real(20309575LL<<24),real(82800575LL<<26),
      ...
      83LL<<25,real(0xb952c68e4fbe9LL),
      // C4[13], coeff of eps^25, polynomial in n of order 1
      -(71903LL<<28),-(1749945LL<<24),reale(5818,0x23b391cd899edLL),
      ...
      -(6781LL<<26),real(0x5fa345ccc643905LL),
      // C4[14], coeff of eps^25, polynomial in n of order 1
      -(5869LL<<31),7353LL<<27,real(0x148e6926290dbdd9LL),
      ...
      71LL<<30,real(0x2213ecbbb96785dLL),
      // C4[15], coeff of eps^25, polynomial in n of order 1
      6799LL<<34,-(2467695LL<<27),reale(43244,0xc47e8e0e2a501LL),
      // C4[15], coeff of eps^24, polynomial in n of order 2
      1754601LL<<37,-(1107369LL<<36),11866753LL<<28,
      ...
      -(13531387LL<<38),-reale(2167,14381LL<<36),real(55828981LL<<37),
      -real(25230703LL<<36),3197649LL<<30,reale(35330975,0x17e35b3509831LL),
      // C4[15], coeff of eps^21, polynomial in n of order 5
      reale(9732,8631LL<<37),-reale(3185,3623LL<<39),-real(35580543LL<<37),
      7839601LL<<38,14184443LL<<37,-real(3642815981LL<<28),
      ...
      -reale(6181,1625LL<<40),reale(2693,7137LL<<39),-(1482145LL<<40),
      ...
      9747283LL<<36,-real(584087189LL<<30),reale(35330975,0x17e35b3509831LL),
      ...
      -(22951LL<<32),reale(14038,0xf79362a6f2da9LL),
      // C4[16], coeff of eps^25, polynomial in n of order 1
      -(9017LL<<35),4815LL<<31,reale(9206,0xf354c01a236f3LL),
      // C4[16], coeff of eps^24, polynomial in n of order 2
      1146319LL<<36,916151LL<<35,-(5763591LL<<32),
      reale(1979494,0x5c2d55f3c2615LL),
      // C4[16], coeff of eps^23, polynomial in n of order 3
      -(15250071LL<<35),5353311LL<<36,-(2240893LL<<35),-(332469LL<<31),
      reale(1979494,0x5c2d55f3c2615LL),
      // C4[16], coeff of eps^22, polynomial in n of order 4
      -reale(2280,6539LL<<38),-real(78951693LL<<36),12301989LL<<37,
      ...
      1LL<<32,real(0x62a61c3e4dd975LL),
      // C4[17], coeff of eps^25, polynomial in n of order 1
      4057LL<<35,-(45015LL<<31),reale(8569,0x3d59f665e75a3LL),
      // C4[17], coeff of eps^24, polynomial in n of order 2
      43463LL<<40,-(16895LL<<39),-(11395LL<<34),
      reale(299923,0x634cafeea1549LL),
      // C4[17], coeff of eps^23, polynomial in n of order 3
      -(1242717LL<<35),138325LL<<36,435713LL<<35,-(3030063LL<<31),
      reale(299923,0x634cafeea1549LL),
      // C4[17], coeff of eps^22, polynomial in n of order 4
      2302621LL<<39,-(9225219LL<<37),1747781LL<<38,-(372113LL<<37),
      -(1948863LL<<32),reale(2099463,0xb718cf86694ffLL),
      ...
      -reale(9776,7093LL<<38),14159215LL<<39,3853577LL<<38,
      ...
      -(56087LL<<33),reale(47221,0xfaefc0318df67LL),
      // C4[18], coeff of eps^25, polynomial in n of order 1
      -(19981LL<<39),-(10755LL<<35),reale(443886,0x9d340e9e9cd95LL),
      // C4[18], coeff of eps^24, polynomial in n of order 2
      84155LL<<39,380011LL<<38,-(1249051LL<<35),
      reale(2219433,0x12044919103e9LL),
      // C4[18], coeff of eps^23, polynomial in n of order 3
      -(2130987LL<<39),379583LL<<40,-(70649LL<<39),-(240567LL<<35),
      reale(2219433,0x12044919103e9LL),
      // C4[18], coeff of eps^22, polynomial in n of order 4
      4417441LL<<38,-(7513869LL<<36),-(1960735LL<<37),4812241LL<<36,
      -(11409363LL<<33),reale(2219433,0x12044919103e9LL),
      // C4[18], coeff of eps^21, polynomial in n of order 5
      -real(28350547LL<<38),4603793LL<<40,-(7176677LL<<38),573937LL<<39,
      220745LL<<38,-(1482145LL<<34),reale(2219433,0x12044919103e9LL),
      ...
      -(113LL<<37),reale(16591,0x81ae2ec54d8dfLL),
      // C4[19], coeff of eps^25, polynomial in n of order 1
      94099LL<<40,-(1178305LL<<35),reale(2339402,0x6cefc2abb72d3LL),
      // C4[19], coeff of eps^24, polynomial in n of order 2
      41263LL<<43,-(6583LL<<42),-(117501LL<<36),
      reale(2339402,0x6cefc2abb72d3LL),
      // C4[19], coeff of eps^23, polynomial in n of order 3
      -(384159LL<<40),-(130977LL<<41),286571LL<<40,-(2657049LL<<35),
      reale(2339402,0x6cefc2abb72d3LL),
      // C4[19], coeff of eps^22, polynomial in n of order 4
      64121LL<<46,-(23919LL<<46),6837LL<<45,901LL<<46,-(170289LL<<37),
      reale(2339402,0x6cefc2abb72d3LL),
      // C4[19], coeff of eps^21, polynomial in n of order 5
      -(955747LL<<39),-(1386619LL<<41),7599723LL<<39,-(2983211LL<<40),
      2945369LL<<39,-real(22232175LL<<34),reale(2339402,0x6cefc2abb72d3LL),
      // C4[19], coeff of eps^20, polynomial in n of order 6
      -(2096679LL<<42),4148625LL<<41,-(841269LL<<43),2143479LL<<41,
      -(498253LL<<42),296429LL<<41,-(2667861LL<<35),
      reale(2339402,0x6cefc2abb72d3LL),
      // C4[19], coeff of eps^19, polynomial in n of order 7
      -(3026933LL<<39),2460315LL<<40,-(7010575LL<<39),2166905LL<<41,
      -(9101001LL<<39),3853577LL<<40,-(4446435LL<<39),real(38239341LL<<34),
      reale(2339402,0x6cefc2abb72d3LL),
      // C4[20], coeff of eps^26, polynomial in n of order 0
      -(34781LL<<40),reale(2459371,0xc7db3c3e5e1bdLL),
      // C4[20], coeff of eps^25, polynomial in n of order 1
      -(4771LL<<42),-(28479LL<<38),reale(2459371,0xc7db3c3e5e1bdLL),
      // C4[20], coeff of eps^24, polynomial in n of order 2
      -(68467LL<<42),136501LL<<41,-(310209LL<<38),
      reale(2459371,0xc7db3c3e5e1bdLL),
      // C4[20], coeff of eps^23, polynomial in n of order 3
      -(327189LL<<42),20533LL<<43,14681LL<<42,-(78387LL<<38),
      reale(2459371,0xc7db3c3e5e1bdLL),
      // C4[20], coeff of eps^22, polynomial in n of order 4
      -(179129LL<<44),910389LL<<42,-(348793LL<<43),341479LL<<42,
      -(321657LL<<40),reale(2459371,0xc7db3c3e5e1bdLL),
      // C4[20], coeff of eps^21, polynomial in n of order 5
      1952379LL<<42,-(388557LL<<44),975677LL<<42,-(224349LL<<43),132447LL<<42,
      -(296429LL<<38),reale(2459371,0xc7db3c3e5e1bdLL),
      // C4[20], coeff of eps^20, polynomial in n of order 6
      1242423LL<<41,-(3451175LL<<40),1045213LL<<42,-(4322097LL<<40),
      1810109LL<<41,-(2075003LL<<40),4446435LL<<37,
      reale(2459371,0xc7db3c3e5e1bdLL),
      // C4[21], coeff of eps^26, polynomial in n of order 0
      -(199LL<<39),reale(37381,0xc16e795c129fbLL),
      // C4[21], coeff of eps^25, polynomial in n of order 1
      65027LL<<42,-(290455LL<<38),reale(2579341,0x22c6b5d1050a7LL),
      // C4[21], coeff of eps^24, polynomial in n of order 2
      1883LL<<46,1837LL<<45,-(18073LL<<40),reale(2579341,0x22c6b5d1050a7LL),
      // C4[21], coeff of eps^23, polynomial in n of order 3
      871509LL<<42,-(326909LL<<43),317735LL<<42,-(1195627LL<<38),
      reale(2579341,0x22c6b5d1050a7LL),
      // C4[21], coeff of eps^22, polynomial in n of order 4
      -(29971LL<<46),74261LL<<44,-(16907LL<<45),9911LL<<44,-(44149LL<<39),
      reale(859780,0x60ece745ac58dLL),
      // C4[21], coeff of eps^21, polynomial in n of order 5
      -(848003LL<<42),252109LL<<44,-(1027829LL<<42),426173LL<<43,
      -(485639LL<<42),2075003LL<<38,reale(2579341,0x22c6b5d1050a7LL),
      // C4[22], coeff of eps^26, polynomial in n of order 0
      -(2963LL<<40),reale(117361,0x5360ca6881e97LL),
      // C4[22], coeff of eps^25, polynomial in n of order 1
      79LL<<45,-(363LL<<41),reale(117361,0x5360ca6881e97LL),
      // C4[22], coeff of eps^24, polynomial in n of order 2
      -(76751LL<<45),74129LL<<44,-(139337LL<<41),
      reale(2699310,0x7db22f63abf91LL),
      // C4[22], coeff of eps^23, polynomial in n of order 3
      102051LL<<45,-(23023LL<<46),13409LL<<45,-(29733LL<<41),
      reale(2699310,0x7db22f63abf91LL),
      // C4[22], coeff of eps^22, polynomial in n of order 4
      121647LL<<45,-(489555LL<<43),201135LL<<44,-(227953LL<<43),485639LL<<40,
      reale(2699310,0x7db22f63abf91LL),
      // C4[23], coeff of eps^26, polynomial in n of order 0
      -(1LL<<45),reale(5837,0x4b04b152e489LL),
      // C4[23], coeff of eps^25, polynomial in n of order 1
      377LL<<47,-(5665LL<<41),reale(122577,0x627628bccbf3dLL),
      // C4[23], coeff of eps^24, polynomial in n of order 2
      -(57LL<<50),33LL<<49,-(583LL<<42),reale(122577,0x627628bccbf3dLL),
      // C4[23], coeff of eps^23, polynomial in n of order 3
      -(1269LL<<47),517LL<<48,-(583LL<<47),9911LL<<41,
      reale(122577,0x627628bccbf3dLL),
      // C4[24], coeff of eps^26, polynomial in n of order 0
      -(83LL<<47),reale(127793,0x718b871115fe3LL),
      // C4[24], coeff of eps^25, polynomial in n of order 1
      5LL<<50,-(11LL<<46),reale(42597,0xd083d7b05caa1LL),
      // C4[24], coeff of eps^24, polynomial in n of order 2
      245LL<<49,-(275LL<<48),583LL<<45,reale(127793,0x718b871115fe3LL),
      // C4[25], coeff of eps^26, polynomial in n of order 0
      -(1LL<<47),reale(8867,0x4cd786c27dde7LL),
      // C4[25], coeff of eps^25, polynomial in n of order 1
      -(13LL<<50),55LL<<46,reale(26601,0xe6869447799b5LL),
      // C4[26], coeff of eps^26, polynomial in n of order 0
      1LL<<48,reale(2126,0x8c0e9e949456fLL),
    };  // count = 4032
    ...
    static const real coeff[] = {
      ...
      121722048,30168404,real(0x269c465a0c9LL),
      ...
      -125915776,real(90505212),real(0x73d4d30e25bLL),
      ...
      -3245452288LL,real(1965206256),real(0x17609e98859b3LL),
      ...
      -650254352384LL,real(304969986048LL),real(0x171a7cbcbc0a5e7LL),
      ...
      247833LL<<16,4782743552LL,real(0x219ae3fb400f15LL),
      ...
      13087612928LL,real(0x90e6983c364f3dLL),
      // C4[7], coeff of eps^28, polynomial in n of order 1
      -339124158464LL,7239297LL<<14,real(0xcf8f801ee602cdLL),
      ...
      -0x2d470940000LL,-0x71ae7b00000LL,-real(79397539LL<<18),
      ...
      -75441766400LL,-175710732288LL,-429272596480LL,-real(16890107LL<<16),
      -real(23159565LL<<17),-real(0x8210e690000LL),-real(27276821LL<<20),
      -real(0x5bebf1b70000LL),-real(3075032387LL<<17),-real(0x6a5f183250000LL),
      -real(40477467135LL<<18),-real(0x11b5c31caf30000LL),
      -real(0xd14cd352ff20000LL),-reale(6969,0xb17d189610000LL),
      reale(216834,7757873387LL<<19),-reale(2087035,0xf153506af0000LL),
      reale(11091105,0x4b9d7f7a20000LL),-reale(38290720,0xa99fbe31d0000LL),
      reale(91897729,0x9718fbaac0000LL),-reale(156643857,0x418d7e6eb0000LL),
      reale(184759421,0x6102c9a360000LL),-reale(129331594,0xf71b8d2590000LL),
      reale(38395317,0x415c2de726c00LL),reale(61527183561LL,0xb18970e26a4cfLL),
      // C4[8], coeff of eps^29, polynomial in n of order 0
      7241<<16,real(0x112c657acf71bLL),
      // C4[8], coeff of eps^28, polynomial in n of order 1
      1165359LL<<20,3168035LL<<17,real(0x21ffb4a731cf423fLL),
      ...
      1123785LL<<21,13838643LL<<19,real(23159565LL<<20),real(171251217LL<<19),
      real(44667189LL<<23),real(3472549135LL<<19),real(10302054723LL<<20),
      real(162001999341LL<<19),real(500351698399LL<<21),
      reale(8102,6578411627LL<<19),-reale(262912,1458939143LL<<20),
      reale(2634746,8016047177LL<<19),-reale(14551212,731365323LL<<22),
      reale(52133305,8561410375LL<<19),-reale(129964645,2819080401LL<<20),
      reale(232230181,2215647013LL<<19),-reale(298362920,1016411147LL<<21),
      reale(269480987,8039357859LL<<19),-reale(161945649,1493828379LL<<20),
      reale(57837731,7816254593LL<<19),-reale(9237971,9476063903LL<<15),
      reale(69730808036LL,0x96022a9a34351LL),
      // C4[8], coeff of eps^8, polynomial in n of order 21
      292383LL<<17,202215LL<<19,2386137LL<<17,3789747LL<<18,
      real(26247507LL<<17),6294651LL<<21,real(437764365LL<<17),
      real(1112245757LL<<18),real(0x67551030e0000LL),real(28804895217LL<<19),
      real(0x2c0f1d988820000LL),real(0x66a336663d1c0000LL),
      -reale(57641,8501165381LL<<17),reale(631918,3696102011LL<<20),
      -reale(3870503,720372107LL<<17),reale(15639991,0xcc8b836440000LL),
      -reale(44892569,0xd7d7de220000LL),reale(94682509,2360318459LL<<19),
      -reale(147486216,0x5ecdb08ae0000LL),reale(163873573,0xbeaba7b6c0000LL),
      -reale(110855652,0xd3ce78fba0000LL),reale(32332898,0xbdc6e34964000LL),
      reale(69730808036LL,0x96022a9a34351LL),
      // C4[9], coeff of eps^29, polynomial in n of order 0
      16847<<16,real(0x3d2e2985830503LL),
      // C4[9], coeff of eps^28, polynomial in n of order 1
      -(207753LL<<23),1712087LL<<18,real(0x438da32e1600335LL),
      ...
      -(538707LL<<21),-0x41a48c00000LL,-(9728097LL<<21),-(3213907LL<<25),
      -real(333357375LL<<21),-real(1438804621LL<<22),-real(39246385997LL<<21),
      -real(379094211993LL<<23),reale(25645,1674653973LL<<21),
      -reale(290249,472854199LL<<22),reale(1830100,1274307463LL<<21),
      -reale(7588281,99130323LL<<24),reale(22282256,82312105LL<<21),
      -reale(48025833,432719649LL<<22),reale(76964476,1304326427LL<<21),
      -reale(91125940,162742323LL<<23),reale(77471536,1478654845LL<<21),
      -reale(44556474,1023100235LL<<22),reale(15423395,377918063LL<<21),
      -reale(2409905,0x7f0a0dc2b0000LL),reale(25978144170LL,0x7e28f6c5ff5f1LL),
      // C4[9], coeff of eps^9, polynomial in n of order 20
      -34760294400LL,-118491709440LL,-441537527808LL,-0x1a9b6380000LL,
      -0x7d359800000LL,-real(90604825LL<<19),-real(308056405LL<<20),
      -real(5606626571LL<<19),-real(20270111449LL<<21),
      ...
      14059LL<<19,real(0x168a4531304537LL),
      // C4[10], coeff of eps^28, polynomial in n of order 1
      -0x3d4bdc00000LL,-0x19bc9880000LL,reale(3807,0xdf0925caacfb9LL),
      ...
      1233981LL<<23,14104237LL<<22,6201077LL<<26,real(933195507LL<<22),
      real(6966040851LL<<23),real(592370721657LL<<22),
      ...
      57057LL<<20,126819LL<<21,1284843LL<<20,478667LL<<24,real(56414325LL<<20),
      real(279062861LL<<21),real(8810413183LL<<20),real(99625441377LL<<22),
      ...
      -133782044672LL,real(0xbdc79d6e266b55fLL),
      // C4[11], coeff of eps^28, polynomial in n of order 1
      -(535829LL<<26),6461547LL<<20,real(0x56e2cdab4666fea1LL),
      // C4[11], coeff of eps^27, polynomial in n of order 2
      -real(54075943LL<<25),-0xa80833000000LL,-real(184884229LL<<19),
      ...
      -(2506701LL<<25),-(1595211LL<<29),-real(414133331LL<<25),
      ...
      -(13041LL<<24),-(166957LL<<23),-(82777LL<<27),-0x6bfe39800000LL,
      -real(121102751LL<<24),-real(11919970777LL<<23),real(140288886837LL<<25),
      -reale(15649,252654239LL<<23),reale(133731,225409843LL<<24),
      -reale(773734,115698949LL<<23),reale(3285982,23309223LL<<26),
      -reale(10716783,181102411LL<<23),reale(27557442,232845957LL<<24),
      -reale(56645854,420384689LL<<23),reale(93299054,125728615LL<<25),
      -reale(121534295,132369527LL<<23),reale(119605179,120525655LL<<24),
      -reale(75403265,163638237LL<<23),reale(21207168,6304582341LL<<18),
      reale(94341681461LL,0x436c57c191ed7LL),
      // C4[12], coeff of eps^29, polynomial in n of order 0
      2113LL<<23,real(0x495846bc80a035LL),
      // C4[12], coeff of eps^28, polynomial in n of order 1
      -(5059597LL<<25),-real(23775299LL<<22),reale(61953,0x75e619a89ce07LL),
      ...
      -(7273579LL<<33),reale(21376966,0x1d2a1f8b6ccdLL),
      ...
      1030055LL<<30,real(829418525LL<<26),-real(19924010015LL<<27),
      ...
      127075LL<<24,91195LL<<28,real(26902525LL<<24),real(715607165LL<<25),
      -real(73094160425LL<<24),reale(4440,35913265LL<<26),
      -reale(41519,978831LL<<24),reale(264211,112928967LL<<25),
      -reale(1241795,175695285LL<<24),reale(4515620,18853435LL<<27),
      -reale(13069247,261014043LL<<24),reale(30619380,129358865LL<<25),
      -reale(58537051,226171969LL<<24),reale(91194564,65482939LL<<26),
      -reale(113993206,58979239LL<<24),reale(109036979,115740763LL<<25),
      -reale(67602927,138149837LL<<24),reale(18850816,700509149LL<<21),
      reale(102545305936LL,0x27e511795bd59LL),
      // C4[13], coeff of eps^29, polynomial in n of order 0
      -(634219LL<<23),reale(3193,0x402148867236bLL),
      // C4[13], coeff of eps^28, polynomial in n of order 1
      -(400561LL<<32),1739049LL<<27,reale(66909,0xbcc54ee94d445LL),
      ...
      -(94185LL<<30),-real(86179275LL<<26),real(2372802705LL<<27),
      ...
      41LL<<28,real(0x3fbc634a12a6b1LL),
      // C4[14], coeff of eps^28, polynomial in n of order 1
      -(6907093LL<<31),-real(59887787LL<<28),reale(5739014,0x909af11944e4bLL),
      ...
      -(204761LL<<28),reale(20426,0xaa7b82b97d24fLL),
      // C4[15], coeff of eps^28, polynomial in n of order 1
      -(34699LL<<42),real(26415501LL<<29),reale(6134808,0xac3bb24726559LL),
      ...
      553LL<<31,real(0x292ecb9a960d27d1LL),
      // C4[16], coeff of eps^28, polynomial in n of order 1
      -(61453LL<<36),-(4754645LL<<34),reale(19591808,0x57955a5f17535LL),
      ...
      -(280331LL<<31),reale(154847,0x4e6e7be138cdbLL),
      // C4[17], coeff of eps^28, polynomial in n of order 1
      -(82431LL<<38),142069LL<<33,reale(989485,0x4511e2f2b39a3LL),
      ...
      35LL<<34,real(0x29845c2bcb5c10d7LL),
      ...
      -(69697LL<<34),reale(220556,0x6c98ea537e51fLL),
      // C4[19], coeff of eps^28, polynomial in n of order 1
      -(1238839LL<<41),675087LL<<35,reale(141943813,0x222cc7846d81LL),
      ...
      1LL<<39,reale(386445,0x44b61aebc827LL),
      ...
      -(2017699LL<<39),reale(144690669,0x92d5d14b2b5b9LL),
      // C4[21], coeff of eps^28, polynomial in n of order 1
      -reale(21806,31LL<<47),-(1751493LL<<42),
      reale(7668605487LL,0x6644548ff9f4dLL),
      // C4[21], coeff of eps^27, polynomial in n of order 2
      -(610053LL<<43),reale(66113,223LL<<42),-reale(23877,14131LL<<38),
      reale(7668605487LL,0x6644548ff9f4dLL),
      ...
      -(229LL<<43),reale(2018939,0x935060fc493cdLL),
      ...
      -(1351LL<<51),-(234789LL<<44),reale(1676392827,0x7a5fe79ee0e95LL),
      ...
      -(1439LL<<46),reale(44813556,0x37a4fd885dffdLL),
      ...
      -(3707LL<<46),reale(12720731,0x2bd144a4925efLL),
      // C4[25], coeff of eps^28, polynomial in n of order 1
      301LL<<53,-(2379LL<<48),reale(139928042,0xe1fdf3124a145LL),
      ...
      -(1LL<<49),reale(131359,0xe834f81ee20c1LL),
      ...
      -reale(11556,0),reale(3294,0),-(3599LL<<49),
      ...
      -(2029LL<<49),reale(16766976,0xd0e6a80084b19LL),
      // C4[27], coeff of eps^28, polynomial in n of order 1
      7LL<<56,-(61LL<<50),reale(5588992,0x45a238002c3b3LL),
      // C4[27], coeff of eps^27, polynomial in n of order 2
      reale(3080,0),-(427LL<<54),3599LL<<49,reale(16766976,0xd0e6a80084b19LL),
      // C4[28], coeff of eps^29, polynomial in n of order 0
      -(1LL<<53),reale(827461,0x318a62b8e0a5bLL),
      // C4[28], coeff of eps^28, polynomial in n of order 1
      -(29LL<<55),61LL<<52,reale(2482383,0x949f282aa1f11LL),
      // C4[29], coeff of eps^29, polynomial in n of order 0
      1LL<<53,reale(88602,0xec373d36a45dfLL),
    };  // count = 5425
#else
