...
namespace GeographicLib {
             ...
             sqrt( fmax(real(0.001), fabs(_f)) * fmin(real(1), 1 - _f/2) / 2 ))
  {
    ...
    // Required number of terms in DST for full accuracy for float, double,
    // long double, quad precision as a function of n in [-0.91, 0.91].  For
    // each precision the P- and P+ columns list the values for negative and
    // positive n.  Values determined by running develop/AreaEst compiled with
    // GEOGRAPHICLIB_PRECISION = 5.  These values reflect the "standard" values
    // of numeric_limits<T>::epsilon(), i.e., 0.5^p with p = 23, 52, 63, 112.

    //        float    double   long d   quad
    // n      f-  f+   d-  d+   l-  l+   q-  q+
    // 0.01    4   4    6   6    8   8   16  16
    // 0.02    4   4    8   8   12  12   24  24
    // 0.03    4   4    8   8   12  12   24  24
    // 0.04    4   4   12  12   12  12   24  24
    // 0.05    4   4   12  12   12  12   24  24
    // 0.06    4   4   12  12   12  12   24  24
    // 0.07    4   4   12  12   16  16   32  32
    // 0.08    4   4   12  12   16  16   32  32
    // 0.09    4   4   12  12   16  16   32  32
    // 0.1     4   4   12  12   16  16   32  32
    // 0.11    6   4   12  12   16  16   32  32
    // 0.12    6   6   16  16   16  16   32  32
    // 0.13    6   6   16  16   24  16   48  32
    // 0.14    6   6   16  16   24  24   48  48
    // 0.15    6   6   16  16   24  24   48  48
    // 0.16    6   6   16  16   24  24   48  48
    // 0.17    6   6   16  16   24  24   48  48
    // 0.18    6   6   16  16   24  24   48  48
    // 0.19    6   6   16  16   24  24   48  48
    // 0.2     6   6   24  16   24  24   48  48
    // 0.21    6   6   24  24   24  24   48  48
    // 0.22    8   6   24  24   24  24   48  48
    // 0.23    8   6   24  24   24  24   48  48
    // 0.24    8   6   24  24   24  24   48  48
    // 0.25    8   6   24  24   32  24   48  48
    // 0.26    8   6   24  24   32  24   64  48
    // 0.27    8   8   24  24   32  32   64  64
    // 0.28    8   8   24  24   32  32   64  64
    // 0.29    8   8   24  24   32  32   64  64
    // 0.3     8   8   24  24   32  32   64  64
    // 0.31   12   8   24  24   32  32   64  64
    // 0.32   12   8   24  24   32  32   64  64
    // 0.33   12   8   24  24   32  32   64  64
    // 0.34   12   8   32  24   32  32   64  64
    // 0.35   12   8   32  24   32  32   64  64
    // 0.36   12   8   32  24   48  32   96  64
    // 0.37   12   8   32  32   48  32   96  64
    // 0.38   12   8   32  32   48  32   96  96
    // 0.39   12   8   32  32   48  48   96  96
    // 0.4    12   8   32  32   48  48   96  96
    // 0.41   12   8   32  32   48  48   96  96
    // 0.42   12  12   32  32   48  48   96  96
    // 0.43   12  12   32  32   48  48   96  96
    // 0.44   12  12   48  32   48  48   96  96
    // 0.45   12  12   48  32   48  48   96  96
    // 0.46   16  12   48  32   48  48   96  96
    // 0.47   16  12   48  32   48  48   96  96
    // 0.48   16  12   48  32   48  48   96  96
    // 0.49   16  12   48  48   48  48   96  96
    // 0.5    16  12   48  48   64  48   96  96
    // 0.51   16  12   48  48   64  48  128  96
    // 0.52   16  12   48  48   64  48  128  96
    // 0.53   16  12   48  48   64  48  128 128
    // 0.54   16  12   48  48   64  48  128 128
    // 0.55   16  12   48  48   64  64  128 128
    // 0.56   24  12   48  48   64  64  128 128
    // 0.57   24  12   48  48   64  64  128 128
    // 0.58   24  12   64  48   64  64  128 128
    // 0.59   24  12   64  48   64  64  128 128
    // 0.6    24  12   64  48   96  64  192 128
    // 0.61   24  12   64  48   96  64  192 128
    // 0.62   24  12   64  48   96  64  192 128
    // 0.63   24  16   64  48   96  64  192 192
    // 0.64   24  16   64  64   96  64  192 192
    // 0.65   24  16   64  64   96  96  192 192
    // 0.66   24  16   96  64   96  96  192 192
    // 0.67   24  16   96  64   96  96  192 192
    // 0.68   32  16   96  64   96  96  192 192
    // 0.69   32  16   96  64   96  96  192 192
    // 0.7    32  16   96  64   96  96  192 192
    // 0.71   32  16   96  64  128  96  192 192
    // 0.72   32  16   96  64  128  96  256 192
    // 0.73   32  16   96  96  128  96  256 192
    // 0.74   32  16   96  96  128  96  256 256
    // 0.75   48  16   96  96  128  96  256 256
    // 0.76   48  16  128  96  128 128  256 256
    // 0.77   48  24  128  96  192 128  256 256
    // 0.78   48  24  128  96  192 128  384 256
    // 0.79   48  24  128  96  192 128  384 256
    // 0.8    48  24  128  96  192 128  384 384
    // 0.81   48  24  128  96  192 128  384 384
    // 0.82   48  24  192  96  192 192  384 384
    // 0.83   64  24  192 128  192 192  384 384
    // 0.84   64  24  192 128  256 192  384 384
    // 0.85   64  24  192 128  256 192  512 384
    // 0.86   64  24  192 128  256 192  512 384
    // 0.87   96  24  192 128  256 192  512 512
    // 0.88   96  24  256 192  384 192  768 512
    // 0.89   96  24  256 192  384 256  768 512
    // 0.9    96  24  256 192  384 256  768 768
    // 0.91  128  24  384 192  384 256  768 768
# if GEOGRAPHICLIB_PRECISION == 1
    ...
    else if (_n >= -0.67 && _n <= 0.91) _nC4 = 24;
    else if (_n >= -0.74 && _n <= 0.91) _nC4 = 32;
    else if (_n >= -0.82 && _n <= 0.91) _nC4 = 48;
    else if (_n >= -0.86 && _n <= 0.91) _nC4 = 64;
    else if (_n >= -0.90 && _n <= 0.91) _nC4 = 96;
    else if (_n >= -0.91 && _n <= 0.91) _nC4 = 128;
    else _nC4 = 192;
# elif GEOGRAPHICLIB_PRECISION == 2
    ...
    else if (_n >= -0.87 && _n <= 0.91) _nC4 = 192;
    else if (_n >= -0.90 && _n <= 0.91) _nC4 = 256;
    else if (_n >= -0.91 && _n <= 0.91) _nC4 = 384;
    else _nC4 = 512;
...
# else // GEOGRAPHICLIB_PRECISION == 4 || GEOGRAPHICLIB_PRECISION == 5
    ...
    else if (_n >= -0.91 && _n <= 0.91) _nC4 = 768;
    else _nC4 = 1024;
#endif
#if GEOGRAPHICLIB_PRECISION == 5
    // Scale up _nC4 by the number of digits in the precision relative to
    // GEOGRAPHICLIB_PRECISION == 4 (= 113).
    int N = (Math::digits() * _nC4) / 113;
