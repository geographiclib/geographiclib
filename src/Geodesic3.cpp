...
namespace GeographicLib {
  ...
  Geodesic3::Inverse(Angle bet1, Angle omg1, Angle bet2, Angle omg2,
    ...
    //       be generated by multiplying tan(alp1) and tan(alp2) by a constant.
    ...
    //     Prolate: this treat the general case
    //
    ...
    if (bet1.c() * omg1.s() == 0 && bet2.c() * omg2.s() == 0) {
      ...
      if (E * omg2a.s() >= -numeric_limits<real>::epsilon()/2) {
        ...
        // the equatorial geodesic because m12 >= 0.  In fact there may be two
